...
class Parser (WaxeyeParser):
    ...
    automata = [FA("stmt_list", [State([Edge(1, 0, False),
            ...
            State([], True)], FA.LEFT),
        FA("statement", [State([Edge(46, 1, False)], False),
        ...
        FA("comment_ln", [State([Edge([(9, 10), "\r", " "], 0, False),
                Edge("/", 1, False)], False),
            State([Edge("/", 2, False)], False),
            State([Edge(48, 3, False)], True),
            State([Edge(-1, 2, False)], False)], FA.VOID),
        FA("comment_bl", [State([Edge([(9, 10), "\r", " "], 0, False),
                Edge("/", 1, False)], False),
            State([Edge("*", 2, False)], False),
        ...
        FA("fun", [State([Edge("f", 1, True)], False),
            ...
            State([Edge(46, 6, False)], False),
            State([Edge(37, 7, False)], False),
            State([Edge(46, 8, False)], False),
            State([Edge("{", 9, True)], False),
            State([Edge(0, 10, False)], False),
            State([Edge(46, 11, False)], False),
            State([Edge("}", 12, True)], False),
            State([Edge(46, 13, False)], False),
            State([], True)], FA.LEFT),
        ...
        FA("class", [State([Edge("c", 1, True)], False),
            ...
            State([Edge(47, 8, False),
                Edge(46, 17, False)], False),
            ...
            State([Edge(46, 17, False)], False),
            State([Edge("{", 18, True)], False),
            State([Edge(19, 19, False)], False),
            State([Edge(46, 20, False)], False),
            State([Edge("}", 21, True)], False),
            State([Edge(46, 22, False)], False),
            State([], True)], FA.LEFT),
        ...
        FA("cls_def", [State([Edge("s", 1, False),
            ...
            State([Edge(47, 9, False)], False),
            State([Edge(37, 10, False)], False),
            State([], True),
            State([Edge("u", 12, False)], False),
            State([Edge("b", 13, False)], False),
            State([Edge(47, 7, False)], False)], FA.LEFT),
        FA("cls_fun", [State([Edge("s", 1, False),
            ...
            State([Edge(47, 11, False)], False),
            State([Edge(10, 12, False)], False),
            State([Edge(46, 13, False)], False),
            State([Edge(37, 14, False)], False),
            State([Edge(46, 15, False)], False),
            State([Edge("{", 16, True)], False),
            State([Edge(0, 17, False)], False),
            State([Edge(46, 18, False)], False),
            ...
            State([Edge(47, 7, False)], False)], FA.LEFT),
        FA("cls_stmt", [State([Edge(46, 1, False)], False),
        ...
        FA("cls_stm_lst", [State([Edge(18, 0, False),
                Edge(46, 1, False)], False),
            State([], True)], FA.LEFT),
        FA("expr", [State([Edge(46, 1, False)], False),
        ...
        FA("negation", [State([Edge("-", 1, False),
            ...
            State([], True)], FA.PRUNE),
        FA("access", [State([Edge(34, 1, False)], False),
            State([Edge(".", 2, True)], True),
            State([Edge(10, 3, False)], False),
            State([], True)], FA.PRUNE),
        FA("indexing", [State([Edge(35, 1, False)], False),
            State([Edge(46, 2, False)], False),
            ...
            State([Edge(46, 6, False)], False),
            State([], True)], FA.PRUNE),
        FA("fun_call", [State([Edge(36, 1, False)], False),
            State([Edge(46, 2, False)], False),
            State([Edge("(", 3, True)], True),
            State([Edge(11, 4, False)], False),
            State([Edge(")", 5, True)], False),
        ...
        FA("type", [State([Edge("s", 1, False),
            ...
            State([Edge(46, 25, False)], False),
            State([Edge(37, 6, False)], False)], FA.LEFT),
        FA("string", [State([Edge("\'", 1, True),
                Edge("\"", 5, True)], False),
            State([Edge(49, 2, False),
                Edge("\'", 3, True)], False),
            State([Edge(39, 1, False)], False),
            State([Edge(46, 4, False)], False),
            State([], True),
            State([Edge(50, 6, False),
                Edge("\"", 7, True)], False),
            State([Edge(39, 5, False)], False),
            State([Edge(46, 4, False)], False)], FA.LEFT),
        ...
        FA("hex", [State([Edge("0", 1, True)], False),
            ...
            State([Edge([(48, 57), (65, 70), (97, 102)], 3, False),
                Edge(46, 4, False)], False),
            State([], True)], FA.LEFT),
        FA("number", [State([Edge(41, 1, False),
                Edge(42, 1, False),
                Edge(43, 1, False),
